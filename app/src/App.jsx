  ...
  return (
    ...
    {/* <Head>
     ...
     <div className='bg-white flex py-8 flex-col text-white sticky top-0 left-0 h-[100vh] px-2 w-[20%]'>
      ...
      <button onClick={() => setCurrentIndex(0)} className={`w-[98%] py-2 rounded-sm flex justify-start px-3  cursor-pointer text-[#051131] ${ currentIndex === 0? 'font-bold' : 'font-normal'}`}><h1>Term-Financial Visualization</h1></button>
     ...
     <div className='w-[80%] h-[100%] px-5 text-black py-5 flex flex-col items-end'>
      ...
      <h1 className='text-[0.8rem]'>Pages / { currentIndex === 1 && "Financial Visualization" } { currentIndex === 0 && "Term-Financial Visualization" } { currentIndex === 2 && "Terms Visualization" }</h1>
